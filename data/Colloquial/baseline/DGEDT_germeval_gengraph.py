...
if __name__ == '__main__':
   edge_vocab = process('./datasets/germeval/germeval_train.raw', None, True)
   process('./datasets/germeval/germeval_valid.raw', edge_vocab, False)
   process('./datasets/germeval/germeval_test.raw', edge_vocab, False)
