...
if __name__ == '__main__':
    ...
    with open('germeval_Train.json', 'w', encoding='utf-8') as tr_fp:
    ...
    with open('germeval_Valid.json', 'w', encoding='utf-8') as va_fp:
    ...
    with open('germeval_Test.json', 'w', encoding='utf-8') as te_fp:
