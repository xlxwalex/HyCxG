...
import pickle
import stanza
nlp = stanza.Pipeline('tr', tokenize_pretokenized=True) # initialize turkish neural pipeline
...
if __name__ == '__main__':
    process('./datasets/turkish/restaurant_train.raw')
    process('./datasets/turkish/restaurant_test.raw')